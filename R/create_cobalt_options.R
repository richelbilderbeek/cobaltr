...
create_cobalt_options <- function(
  search_pattern_filename = file.path(
    get_default_cobalt_folder(), "patterns"
  ),
  domain_database_filename = file.path(get_default_cobalt_folder(), "cdd"),
  conserved_block_filename = file.path(
    get_default_cobalt_folder(), "cdd.blocks"
  ),
  residue_frequencies_filename = file.path(
    get_default_cobalt_folder(), "cdd.freq"
  ),
